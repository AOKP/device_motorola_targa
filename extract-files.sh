...
adb pull /system/lib/hw/gps.targa.so ../../../vendor/motorola/$DEVICE/proprietary
...
adb pull /system/lib/hw/lights.targa.so ../../../vendor/motorola/$DEVICE/proprietary
...
adb pull /system/usr/keychars/cdma_targa-keypad.kcm.bin ../../../vendor/motorola/$DEVICE/proprietary
...
adb pull /system/usr/keylayout/cdma_targa-keypad.kl ../../../vendor/motorola/$DEVICE/proprietary
...
# system/lib/hw
PRODUCT_COPY_FILES += \\
vendor/motorola/__DEVICE__/proprietary/gps.targa.so:/system/lib/hw/gps.targa.so \\
vendor/motorola/__DEVICE__/proprietary/gralloc.omap4.so:/system/lib/hw/gralloc.omap4.so \\
vendor/motorola/__DEVICE__/proprietary/lights.targa.so:/system/lib/hw/lights.targa.so \\
vendor/motorola/__DEVICE__/proprietary/sensors.targa.so:/system/lib/hw/sensors.targa.so \\
